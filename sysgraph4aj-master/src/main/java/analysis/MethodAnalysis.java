...
public class MethodAnalysis {	
	...
	public static void analyseMethod(SysMethod sm, SysRoot root){
		...
		if(methodCalls != null){
		    ...
		    System.out.println("* Warning - [MethodAnalysis]: No methods inside to analyse.");
		}
	 ...
	 */
	public static SysElement tryOption(SysElement m, String string, String signature, SysRoot sysRoot)
	...
	public static SysElement tryOption(SysAspect c, String pathToFind, String signature, SysRoot root)
	        throws PathNotFoundException {
