...
public class ModelToGraph {
	...
	public static void addEspecialEdges(
			Forest<IElement, Object> f,
			EspecialEdgesTable<IElement, Object> et) {
		if ((et != null) && (f != null)) {
			Vector<IElement> from = et.getFrom();
			Vector<IElement> to = et.getTo();
			Vector<Object> edge = et.getEdge();
			for (int i = 0; i < edge.size(); i++) {
				f.addEdge(f.getEdgeCount() + 1.5f,
						from.get(i), to.get(i));
			}
		}
		else {
			System.err.println("et==null || f==null");
		}
	}

	public static DelegateTree<IElement, Object> delegateTree_fullGraph(
			IElement root) {
		DelegateTree<IElement, Object> dt = new DelegateTree<>();
		dt.addVertex(root);
		dt = putAllChildren(dt, root);
		return dt;
	}

	public static DelegateTree<IElement, Float> delegateTree_justFirstChildren(
			IElement root) {
	...
	private static EspecialEdgesTable<IElement, Object> getEspecialEdges(
			SysAdvice m, Graph g) {
		EspecialEdgesTable<IElement, Object> e = getEspecialEdges(
				(SysMethod) m, g);
		if (e == null) {
			e = new EspecialEdgesTable<IElement, Object>();
		}
	...
	public static EspecialEdgesTable<IElement, Object> getEspecialEdges(
			SysRoot r, Graph g) {
		if (r != null) {
			EspecialEdgesTable<IElement, Object> et = new EspecialEdgesTable<IElement, Object>();
	...
	public static DelegateTree<IElement, Object> putAllChildren(
			DelegateTree<IElement, Object> dt, IElement e) {
		if (e != null) {

			for (IElement e1 : e.getChildElements()) {
				dt.addChild((float) dt.getEdgeCount(), e,
						e1);
	...
	public static DelegateTree<IElement, Object> putAllChildren_SysRoot(
			DelegateTree<IElement, Object> dt, SysRoot e) {
		if (e != null) {
	...
	public static void removeEspecialEdges(
			DelegateForest<IElement, Object> f,
			EspecialEdgesTable<IElement, Object> et) {
	...
	public static DelegateForest<IElement, Object> tree_to_forest(
			DelegateTree dt) {
		if (dt == null) {
			return null;
		}
