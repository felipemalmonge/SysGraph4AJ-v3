...
public class SysUtils {
    ...
    /**
     * Same thing as setCenter but this time it makes a good visual for the
    ...
    /**
     * Makes a good visual, i.e., set transformers to put color in the graph,
     * set names, and tooltip
     */
    ...
    /**
     * Retorna um objeto de visualização {@link VisualizationViewer}
     * representado a partir de um objeto da classe {@link SysRoot}
     *
     * @param root Parametro que referencia a raiz do programa.
     * @param deltaX
     * @param deltaY
     * @return
     */
    public static VisualizationViewer<IElement, Object>
            createVisualizationViewerBySysRoot(SysRoot root, int deltaX, int deltaY) {

        DelegateTree<IElement, Object> delegateTree = new DelegateTree<>();
        delegateTree.addVertex(root);
        ModelToGraph.putAllChildren_SysRoot(delegateTree, root);
        
        DelegateForest<IElement, Object> delegateForest = new DelegateForest<>(delegateTree);
